...
import com.yl.common.dao.ResourceMapper;
import com.yl.common.dao.RoleResourceMapper;
 ...
 */
@Service
public class JieInvocationSecurityMetadataSourceService implements FilterInvocationSecurityMetadataSource {
    ...
    private void loadResourceDefine() {
        ...
        System.out.println("========获取所有url和角色列表完成=======");
    ...
    public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
        System.out.println("=====开始根据url查找相关的权限配置========");
